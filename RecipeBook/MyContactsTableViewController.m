//
//  MyContactsTableViewController.m
//  Bengaluru
//
//  
#import "MyContactsTableViewController.h"
#import "DetailViewController.h"
#import "BengaluruBookAppDelegate.h"

@interface MyContactsTableViewController ()

@end

@implementation MyContactsTableViewController
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    NSFetchRequest *fetchRequest = [[NSFetchRequest alloc] initWithEntityName:@"MyContact"];
